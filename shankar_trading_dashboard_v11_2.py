...
APP_VERSION = "V11.2 Auto Token Pro"
...
def build_trade_plan(
    ...
    if not contract.get("ok"):
        plan["note"] = "V11.1 blocked contract: " + str(contract.get("reason", "weak liquidity/quality"))
        return plan
...
# V11.1 confirmation veto: strong opposite option-flow prevents a fresh BUY setup.
...
if trade_plan["side"] != "WAIT" and not liquidity["ok"]:
    ...
    trade_plan["note"] = liquidity["reason"] + ". Trade blocked by V11.1 liquidity/data-quality filter."
